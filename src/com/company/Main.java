...
//        String action 		= "publish";
        ...
        int qos 			= 2;
        String broker 		= "www.songyun.work";
        int port 			= 1883;
        ...
        try {
            ...
            Main sampleClient = new Main(url, clientId, cleanSession, quietMode,userName,password);
     ...
     */
    public Main(String brokerUrl, String clientId, boolean cleanSession, boolean quietMode, String userName, String password) throws MqttException {
